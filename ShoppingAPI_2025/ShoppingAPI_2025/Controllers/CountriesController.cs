...
namespace ShoppingAPI_2025.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        /*Todos los controladores son muy parecidos, cambia el nombre, a que interfaz llama, nombre de metodos,
         algun endpoint adicional. 
        El flujo normal de un controlador: Voy, consulto, retorno, valido que no sea nulo y muestro, la logica esta en el servicio*/
    }
}
